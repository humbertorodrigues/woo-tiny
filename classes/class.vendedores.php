...
class vendedores{
    ...
    function extra_user_profile_fields( $user ) { ?>
        ...
        <tr>
            ...
            <td>
                <input type="text" name="bw_id_vendedor_tiny_bw" id="bw_id_vendedor_tiny_bw" value="<?php echo $bw_id_vendedor_tiny_bw ?>" class="regular-text" /><br />
        ...
        <tr>
            ...
            <td>
                <input type="text" name="bw_id_vendedor_tiny_vinicola" id="bw_id_vendedor_tiny_vinicola" value="<?php echo $bw_id_vendedor_tiny_vinicola ?>" class="regular-text" /><br />
