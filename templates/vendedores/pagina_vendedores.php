            ...
            <div class="row mt-3">
                <form>
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="form-group">
                                <input type="text" class="form-control" name="nome" placeholder="Nome do cliente ou razão social">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <input type="text" class="form-control" name="rg_inscricao" placeholder="RG/Inscrição Estadual">
                            </div>
                        </div>
                    </div>
                    <div class="row mt-3">
                    ...
                    <div class="row mt-3">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <input type="text" class="form-control" name="nome_contato" placeholder="Contato (Nome)">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                        ...
                        <div class="col-lg-12">
                            <div class="form-check">
                              <label class="form-check-label">
                                <input type="checkbox" class="form-check-input" name="revisao" id="revisao" value="revisao" >
                    ...
                    <div class="row mt-3">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <textarea class="form-control" name="obs" rows="3" placeholder="Observações (Detalhes sobre entrega, restrições, horários, endereços diferenciados, referências, etc)"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row mt-3 d-none">
                        ...
                        <div class="col-lg-10">
                            <div class="form-group">
                                <select class="form-control" id="produto">
                                    ...
                                    foreach ($produtos as $key => $produto) {
                                    ?>
                                        <option data-descricao="<?php echo $produto->get_title() ?>" value="<?php echo $produto->get_id() ?>"><?php echo $produto->get_title() ?></option>
                                    <?php
                                    }
                                    ?>
                                </select>
                        ...
                        <div class="col-lg-2">
                            <div class="row">
                                <div class="col-12">
                                    <button id="adicionar_produto" class="btn btn-sm btn-secondary" type="button">Adicionar</button>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <table id="pedido_venda" class="table table-striped">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><input min="0" class="qtd" name="qtd[]" id="qtd_<?php echo $produto->get_id() ?>" type="number" value="0"></td>
                                    <td><input min="0" class="qtd_bonificacao" name="qtd_bonificacao[]" id="qtd_bonificacao_<?php echo $produto->get_id() ?>" type="number" value="0"></td>
                                    <td><input class="preco_unitario" id="preco_unitario_<?php echo $produto->get_id() ?>" readonly type="number" name="preco_unitario[]"></td>
                                    <td><input value="<?php echo $preco_bonificacao ?>" class="preco_unitario_bonificacao" id="preco_unitario_bonificacao_<?php echo $produto->get_id() ?>" readonly type="number" name="preco_unitario_bonificacao[]"></td>
                                    <td><input class="subtotal" data-idproduto="<?php echo $produto->get_id() ?>" id="subtotal_<?php echo $produto->get_id() ?>" readonly type="number" name="subtotal[]"></td>
